        ...
        <form class="d-flex" action="crud_producto.php" method="post">
            <div class="col">
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_producto" id="txt_producto" class="form-control" placeholder="Producto: Tenis "
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control"
                        placeholder="Descripcion: Blancos" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" name="txt_precio_costo" id="txt_precio_costo" class="form-control"
                        placeholder="Precio Costo: 300" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" name="txt_precio_venta" id="txt_precio_venta" class="form-control"
                        placeholder="Precio Venta: 500" aria-describedby="helpId" Required>
                </div>
                <div class="mb-3">
